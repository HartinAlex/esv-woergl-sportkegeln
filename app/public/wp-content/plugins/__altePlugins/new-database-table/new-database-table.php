...
class PetAdoptionTablePlugin {
  ...
  function __construct() {
    ...
    add_action('admin_post_createpet', array($this, 'createPet')); // ruft die Funktion auf, wenn ein User angemeldet ist (egal ob Admin oder nicht)
    add_action('admin_post_nopriv_createpet', array($this, 'createPet')); // ruft die Funktion auf, wenn der User keine Privilegien hat

    add_action('admin_post_deletepet', array($this, 'deletePet')); // ruft die Funktion auf, wenn ein User angemeldet ist (egal ob Admin oder nicht)
    add_action('admin_post_nopriv_deletepet', array($this, 'deletePet')); // ruft die Funktion auf, wenn der User keine Privilegien hat
