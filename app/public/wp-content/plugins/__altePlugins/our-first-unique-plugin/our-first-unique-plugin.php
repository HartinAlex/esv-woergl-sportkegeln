...
*/
    ...
    class WordCountAndTimePlugin {
        ...
        function settings() {
            ...
            // this is for checkbox read time
...
<?php   }
        ...
        function adminPage() {
            add_options_page('Word Count Settings', esc_html(__('Word Count', 'wcpdomain')), 'manage_options', 'word-count-settings-page', array($this, 'ourHTML'));
        }
