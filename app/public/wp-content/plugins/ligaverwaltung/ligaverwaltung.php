 ...
 */
function ligaverwaltung_ligaverwaltung_block_init() {
	register_block_type_from_metadata( __DIR__ . '/build/verwaltungergebnisse' );
	register_block_type_from_metadata( __DIR__ . '/build/verwaltungspiele' );
	register_block_type_from_metadata( __DIR__ . '/build/verwaltungtabelle' );
}
add_action( 'init', 'ligaverwaltung_ligaverwaltung_block_init' );
