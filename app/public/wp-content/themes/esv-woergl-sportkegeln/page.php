<?php
    ...
    while(have_posts()) {
        ...
        pageBanner(array(
            'title' => get_the_title(),
            'subtitle' => get_field('page_banner_subtitle') . " - page.php"
        ));
        ?>
...
<?php               switch(get_the_ID()) {
                        case 23:
                            get_template_part('template-parts/content-jugend');
                            break;
                        case 245:
                            get_template_part('template-parts/content-spieltag-speichern');
                            break;
                        case 25:
                            get_template_part('template-parts/content-geschichte');
                            break;
                        default:
                            the_content();
                    } 
