...
// import Chart from "./modules/GoogleChart"
...
class MyNotes {
  ...
  createNote(data) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      // => ajax is a great option when you want to control what type of the request you sending
      beforeSend: xhr => {
        xhr.setRequestHeader('X-WP-Nonce', esvData.nonce);
      },
      url: esvData.root_url + '/wp-json/wp/v2/note/',
      // '/wp-json/wp/v2/note/' -> to create a new post type of note; '/wp-json/wp/v2/posts/' -> to create a new post type of posts ...
      type: 'POST',
      // -> POSTING or SENDING data
      data: newPost,
      success: response => {
  ...
  updateNote(data) {
    var currentNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(data.target).parents("li");
    var updatedPost = {
...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(esvData.root_url + '/wp-json/club/v1/search?term=' + this.searchField.val(), results => {
      this.resultsDiv.html(`
                <div class="row">
                    <div class="one-third">
